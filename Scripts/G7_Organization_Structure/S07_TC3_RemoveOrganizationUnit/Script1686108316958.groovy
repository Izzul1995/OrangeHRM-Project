...
WebUI.click(findTestObject('Object Repository/Structure/Page_OrangeHRM/button_Ronaldo_oxd-icon-button org-action-icon'))

WebUI.click(findTestObject('Object Repository/Structure/Page_OrangeHRM/button_Yes, Delete'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Structure/Page_OrangeHRM/p_Successfully Deleted'), 0)
