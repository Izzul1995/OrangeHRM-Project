...
WebUI.verifyElementText(findTestObject('Object Repository/Page_OrangeHRM/h6_Reset Password link sent successfully'), 'Reset Password link sent successfully')
