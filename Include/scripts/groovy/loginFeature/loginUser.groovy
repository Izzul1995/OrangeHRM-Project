...
class loginUser {
	 ...
	 */
	@Given("User navigate to login page") //annotation
	def navigateLogin() //function
	{
		WebUI.openBrowser('')
	...
	@When("User enter (.*) and (.*)")
	def enterDetails(String username, String password) //2 input var
	{
	...
	{
		WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OrangeHRM/p_Paul nihal'), 0)
	}
}