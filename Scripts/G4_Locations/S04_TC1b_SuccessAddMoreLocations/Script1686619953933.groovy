...
WebUI.setText(findTestObject('Object Repository/locations/Page_OrangeHRM/input_Name_oxd-input oxd-input--focus (1)'), 'kampung messi')

WebUI.click(findTestObject('locations/Page_OrangeHRM/select'))
